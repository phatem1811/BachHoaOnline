...
import DaiHoc.BachHoa.service.Imp.EmailService;
...
public class ForgotPasswordController {
	...
	public ForgotPasswordController(UserRepository userRepository, EmailService emailService, ForgotPasswordRepository fpRepository) {
	...
	public ResponseEntity<String> verifyOtp(@PathVariable Integer otp, @PathVariable String email){
		...
		ForgotPassword fp = (ForgotPassword) fpRepository.findByOtpAndUser(otp, user);
